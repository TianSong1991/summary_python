...
root_path = 'I:\\Project_FDS\\original_data\\HX_data\\data1016'


os.chdir(root_path)


files0 = os.listdir(root_path)


for file0 in files0:
    path0 = os.path.join(root_path,file0)
    for file00 in os.listdir(path0):
        path00 = os.path.join(path0,file00)
        files1 = os.listdir(path00)
        for file1 in files1:
            path1 = os.path.join(path00,file1)
