...
data_dir = '/media/pico/data2/SCNN_dataset/lane_video2jpg'

outimgpath = '/media/pico/data2/SCNN_dataset/test1'
...
lib = CDLL("/media/pico/data2/autolabel_jack/YoloAutoLabel/python/libdarknet.so", RTLD_GLOBAL)
...
def write_xml(result,file_path,outim_path):
    ...
    path_xml = "/media/pico/data2/autolabel_jack/YoloAutoLabel/temp.xml"#直接读取一个适合labelimg的xml文件，并在其下面进行修改，然后保存即可
    ...
    for i in range(len(result)):
        ...
        # filename.firstChild.data = img_path
...
if __name__ == "__main__":
    ...
    net = load_net(b"/media/pico/data2/autolabel_jack/YoloAutoLabel/cfg/yolov3.cfg", b"/media/pico/data2/autolabel_jack/YoloAutoLabel/yolov3.weights", 0)
    meta = load_meta(b"/media/pico/data2/autolabel_jack/YoloAutoLabel/cfg/coco.data")
    total_pred_time = 0
