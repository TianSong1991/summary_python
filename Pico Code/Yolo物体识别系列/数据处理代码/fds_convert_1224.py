...
root_path = '/data/aaron/yolotest/darknet/data/testdata2/data/'

images_path = '/data/aaron/yolotest/darknet/data/testdata2/images/'

labels_path = '/data/aaron/yolotest/darknet/data/testdata2/labels/'
...
def convert_function(listdata,labels_path1,images_path1):
	...
	for n in range(num1):
		...
		if extension1 == '.xml':
			...
			image_xml_path = os.path.join(name2,name1+'.bmp')
...
def path_txt(path1):
	img_file = open('/data/aaron/yolotest/darknet/data/fds1224.txt','w')
